    ...
    >
      ...
      <div className="flex flex-row items-center ">
        ...
        <div className="flex flex-row space-x-2 items-center">
          ...
          Quelle est la prochaine étape</span>
        </div>
      </div>
      {/* // ? Get In Touch */}
...
Bien que je sois toujours ouvert à toute nouvelle opportunité, ma boîte de réception est ouverte. Que vous ayez une question ou simplement dire bonjour, je ferai de mon mieux pour vous répondre !
      </p>
      <div className="pt-4">
